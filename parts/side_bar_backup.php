            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="active">
                    <a href="index.php" class="iq-waves-effect"><i
                            class="ri-home-4-line"></i><span>Dashboard 1</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="#menu-design" class="iq-waves-effect collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="ri-menu-3-line"></i><span>Menu Design</span><i
                    ...
                    <ul id="menu-design" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="vertical-top-menu.html"><i class="ri-line-height"></i>Vertical block menu</a>
                        </li>
                    </ul>
                </li>

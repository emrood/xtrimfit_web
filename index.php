        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li class="active">
                        <a href="index.php" class="iq-waves-effect"><i class="ri-home-4-line"></i><span>Dashboard 1</span></a>
                    </li>
                    <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height" style="background: transparent;">
                        <div class="iq-card-body rounded p-0" style="background: url(images/page-img/01.png) no-repeat;    background-size: cover; height: 423px;">
            ...
            <div class="row">
                <div class="col-lg-8 row m-0 p-0">
                    <div class="col-md-6">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height" style="background: transparent; box-shadow: none;">
                            <div class="iq-card-body p-0">
                                <img src="images/booking/03.png" class="img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
